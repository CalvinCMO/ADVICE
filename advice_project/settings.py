...
ALLOWED_HOSTS = config('ALLOWED_HOSTS', default='localhost,*.up.railway.app', cast=Csv())
...
# Database — reads DATABASE_URL from .env or Railway environment
DATABASES = {
...
DEFAULT_FROM_EMAIL = config('DEFAULT_FROM_EMAIL', default='noreply@advice.com')
